...
This project encapsulates Python object-oriented programming, use of inheritance and unittests.
Three classes were connected to each other are created together with their individual test classes.

The three classes involved utilise the following Python tools:
* Import
* Exceptions
* Private attributes
* Getter/setter
